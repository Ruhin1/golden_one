            ...
            async processSale() {
                ...
                try {
                    ...
                    if (response.ok && result.success) {
                        ...
                        this.paidAmount = 0;
                        this.resetCustomer();
                        this.saleDate = this.formatDatetimeLocal(new Date()); // ⬅️ নতুন
